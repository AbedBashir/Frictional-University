...
/*
	...
	Description: Replaces a lit of words.
	Version: 1.0
	Author: Abed Bashir
*/
		...
		<div class="wrap">
					...
					<form method="POST">
						...
						<div class="word-filter__flex-container">
							<textarea name="plugin_words_to_filter" id="plugin_words_to_filter" placeholder="bas, mean, awful, horrible"><?php echo esc_textarea(get_option('plugin_words_to_filter')); ?></textarea>
						</div>
